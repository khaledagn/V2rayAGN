...
import com.agn.v2ray.AngApplication
import com.agn.v2ray.R
import com.agn.v2ray.service.SubscriptionUpdater
import com.agn.v2ray.viewmodel.SettingsViewModel
import java.util.Locale
import java.util.concurrent.TimeUnit
import com.agn.v2ray.util.LanguagePrefs
...
//            }
        ...
        override fun onStart() {
            ...
            muxConcurrency?.summary =
                defaultSharedPreferences.getString(AppConfig.PREF_MUX_CONCURRENCY, "8")
            muxXudpConcurrency?.summary =
                defaultSharedPreferences.getString(AppConfig.PREF_MUX_XUDP_CONCURRENCY, "8")
            ...
            autoUpdateInterval?.isEnabled =
                defaultSharedPreferences.getBoolean(AppConfig.SUBSCRIPTION_AUTO_UPDATE, false)
    ...
    fun onModeHelpClicked(view: View) {
        Utils.openUri(this, AppConfig.V2rayAGNWikiMode)
    }
}
